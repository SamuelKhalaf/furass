    ...
    return {
        ...
        triggerEvent: function(node, eventName) {
            ...
            if (node.dispatchEvent) {
                ...
                // Different trips have different event classes.
                ...
                event.initEvent(eventName, bubbles, true); // All trips created as bubbling and cancelable.

                event.synthetic = true; // allow detection of synthetic trips
