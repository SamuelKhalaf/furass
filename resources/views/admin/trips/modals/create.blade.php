                    ...
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_trip_scroll"
                        ...
                        <div class="row g-5 mb-7">
                            ...
                            <div class="col-md-6 fv-row mb-7">
                                <!--begin::Label-->
                                <label class="required fw-semibold fs-6 mb-2">{{__('trips.modal.event_date_time')}}</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" name="event_time" placeholder="Select Date & Time" class="form-control form-control-solid flatpickr-input" required/>
                            </div>
                        </div>
