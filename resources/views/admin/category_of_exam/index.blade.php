        ...
        <script>
            ...
            var KTUsersUpdateDetails = function () {
                ...
                var populateForm = (response) => {
                    form.querySelector('[name="name_ar"]').value = response.cat_name.ar || "";
                    form.querySelector('[name="name_en"]').value = response.cat_name.en || "";
                        ...
                        if (validator) {
                            validator.validate().then(function (status) {
                                if (status === 'Valid') {
                                    ...
                                    let updateUrl = `/categories/${userId}`;
                                    $.ajax({
                                        url: updateUrl,
                                        type: "POST",
                                        data: formData,
        ...
        <script>
            ...
            $(document).on("click", '[data-kt-users-table-filter="delete_row"]', function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "{{ route('admin.category.destroy', ':id') }}".replace(':id', userId),
                            type: 'DELETE',
