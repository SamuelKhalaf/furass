...
@section('title', 'Consulting Firms')
@section('content')
        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Consulting Firms List</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">Consulting Firms</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text" data-kt-user-table-filter="search"
                                       class="form-control form-control-solid w-250px ps-14" placeholder="Search Consulting Firms"/>
                            </div>
                            <!--end::Search-->
                        </div>
                        <!--begin::Card title-->
                            ...
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                @if(auth()->user()->hasPermissionTo(\App\Enums\PermissionEnum::CREATE_SCHOOLS->value))
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                            data-bs-target="#kt_modal_add_consulting_firm">
                                        <span class="svg-icon svg-icon-2"><i class="fa-solid fa-plus"></i></span>
                                        {{ __('admin.entities.consulting_firms') }} - {{ __('schools.create') }}
                                    </button>
                                @endif
                            </div>
                            <!--end::Toolbar-->
    ...
    @if(auth()->user()->hasPermissionTo(\App\Enums\PermissionEnum::CREATE_SCHOOLS->value))
        <!--begin::Modal - Add Consulting Firm-->
        @include('admin.schools.modals.create', [
            'modalId' => 'kt_modal_add_consulting_firm',
            'formId' => 'kt_modal_add_consulting_firm_form',
            'entityType' => 'consulting_firm',
            'title' => __('admin.entities.consulting_firms') . ' - ' . __('schools.create')
        ])
        <!--end::Modal - Add Consulting Firm-->
    @endif
    @if(auth()->user()->hasPermissionTo(\App\Enums\PermissionEnum::UPDATE_SCHOOLS->value))
        <!--begin::Modal - Update Consulting Firm-->
        @include('admin.schools.modals.edit', [
            'modalId' => 'kt_modal_update_consulting_firm',
            'formId' => 'kt_modal_update_consulting_firm_form',
            'entityType' => 'consulting_firm',
            'title' => __('admin.entities.consulting_firms') . ' - ' . __('schools.modal.update_school')
        ])
        <!--end::Modal - Update Consulting Firm-->
    @endif
@endsection
                    ...
                    datatable = $(table).DataTable({
                        ...
                        buttons: [
                            ...
                            },
                            {
                                ...
                                filename: 'consulting-firms-report',
    ...
    @if(auth()->user()->hasPermissionTo(\App\Enums\PermissionEnum::DELETE_SCHOOLS->value))
        <script>
            ...
            $(document).on("click", '[data-kt-users-table-filter="delete_row"]', function (e) {
                ...
                Swal.fire({
                    text: "Are you sure you want to delete this consulting firm?",
                    icon: "warning",
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            error: function () {
                                Swal.fire({
                                    text: "Failed to delete the consulting firm. Try again Later!",
                                    icon: "error",
                                    buttonsStyling: false,
                                    confirmButtonText: "Ok",
                                    customClass: {
