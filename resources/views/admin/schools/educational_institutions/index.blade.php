        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Educational Institutions List</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">Educational Institutions</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text" data-kt-user-table-filter="search"
                                       class="form-control form-control-solid w-250px ps-14" placeholder="Search Educational Institutions"/>
                            </div>
                            <!--end::Search-->
                        </div>
                        <!--begin::Card title-->
...
@section('scripts')
            ...
            var KTUsersList = function () {
                ...
                var initUserTable = function () {
                    ...
                    datatable = $(table).DataTable({
                        ...
                        processing: true,
                        serverSide: true,
                        ajax: "/educational-institutions/all",
                        columns: [
                            {
                                data: 'name',
                                name: 'name',
                        ...
                        buttons: [
                            ...
                            },
                            {
                                ...
                                filename: 'educational-institutions-report',
    ...
    @if(auth()->user()->hasPermissionTo(\App\Enums\PermissionEnum::DELETE_SCHOOLS->value))
        <script>
            // handle delete educational institution
            $(document).on("click", '[data-kt-users-table-filter="delete_row"]', function (e) {
                ...
                Swal.fire({
                    text: "Are you sure you want to delete this educational institution?",
                    icon: "warning",
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            error: function () {
                                Swal.fire({
                                    text: "Failed to delete the educational institution. Try again Later!",
                                    icon: "error",
                                    buttonsStyling: false,
                                    confirmButtonText: "Ok",
                                    customClass: {
