...
@section('content')
                            ...
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                @if(auth()->user()->hasPermissionTo(\App\Enums\PermissionEnum::CREATE_SCHOOLS->value))
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                        ...
                                        {{ __('admin.entities.companies') }} - {{ __('schools.create') }}
                                    </button>
                                @endif
                            </div>
                            <!--end::Toolbar-->
    ...
    @if(auth()->user()->hasPermissionTo(\App\Enums\PermissionEnum::CREATE_SCHOOLS->value))
        ...
        @include('admin.schools.modals.create', [
            'modalId' => 'kt_modal_add_company',
            'formId' => 'kt_modal_add_company_form',
            'entityType' => 'company',
            'title' => __('admin.entities.companies') . ' - ' . __('schools.create')
        ])
    ...
    @if(auth()->user()->hasPermissionTo(\App\Enums\PermissionEnum::UPDATE_SCHOOLS->value))
        ...
        @include('admin.schools.modals.edit', [
            'modalId' => 'kt_modal_update_company',
            'formId' => 'kt_modal_update_company_form',
            'entityType' => 'company',
            'title' => __('admin.entities.companies') . ' - ' . __('schools.modal.update_school')
        ])
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            error: function () {
                                Swal.fire({
                                    text: "Failed to delete the company. Try again Later!",
                                    icon: "error",
                                    buttonsStyling: false,
                                    confirmButtonText: "Ok",
                                    customClass: {
