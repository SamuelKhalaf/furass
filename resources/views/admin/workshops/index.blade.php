                    ...
                    <div class="card-body py-4">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                            ...
                            <tr class="text-gray-400 fw-bold fs-7 text-uppercase gs-0 text-center">
                                <th class="w-125px">{{ __('workshops.name') }}</th>
                                <th class="w-125px">{{ __('workshops.company_name') }}</th>
                                <th class="w-100px">{{ __('workshops.location') }}</th>
                                <th class="w-150px">{{ __('workshops.start_date') }}</th>
                                <th class="w-150px">{{ __('workshops.end_date') }}</th>
                                <th class="w-50px">{{ __('workshops.media') }}</th>
                                <th class="w-50px">{{ __('workshops.documents') }}</th>
                                <th class="w-100px">{{ __('workshops.actions') }}</th>
                            </tr>
                            <!--end::Table row-->
                            </thead>
                            <!--end::Table head-->
                        ...
                        buttons: [
                            {
                                ...
                                exportOptions: {
                                    columns: [0, 1, 2, 3, 4], // Only export first 5 columns
                                    modifier: {
                                        search: 'none'
                                    }
                                }
