...
@section('title', __('workshops.management.add_volunteer_hours'))
            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">
                        {{ __('workshops.management.add_volunteer_hours') }}
                    </h1>
            ...
            <div id="kt_app_content_container" class="app-container container-fluid">
                ...
                <div class="card mb-5">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="d-flex flex-column">
                                    <span class="text-gray-600 fw-semibold">{{ __('workshops.management.program') }}</span>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="d-flex flex-column">
                                    <span class="text-gray-600 fw-semibold">{{ __('workshops.management.total_students') }}</span>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">
                            <h3 class="fw-bold text-dark">
                                <i class="fa-solid fa-clock text-success me-2"></i>{{ __('workshops.management.student_volunteer_hours') }}
                            </h3>
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('admin.sub-admin.volunteer-hours.store', [$program->id, $pathPoint->id]) }}">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                                        ...
                                        <tr class="fw-bold text-muted">
                                            ...
                                            <th class="min-w-100px">{{ __('workshops.management.student_id_number') }}</th>
                                            <th class="min-w-100px">{{ __('workshops.management.volunteer_hours') }}</th>
                                            <th class="min-w-120px">{{ __('workshops.management.volunteer_date') }}</th>
                                            <th class="min-w-200px">{{ __('workshops.management.description') }}</th>
                                            <th class="min-w-100px">{{ __('workshops.management.current_hours') }}</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" class="form-control form-control-sm"
                                                           ...
                                                           placeholder="{{ __('workshops.management.enter_id_number') }}" required>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <textarea class="form-control form-control-sm"
                                                              ...
                                                              rows="2" placeholder="{{ __('workshops.management.optional_description') }}">{{ $existingVolunteerHour->description ?? '' }}</textarea>
                                                </td>
                                                <td>
                                                    @if($existingVolunteerHour)
                                                        <span class="badge badge-light-success">
                                                            <i class="fa-solid fa-clock me-1"></i>{{ $existingVolunteerHour->hours }} {{ __('workshops.management.hours') }}
                                                        </span>
                                                    ...
                                                    @else
                                                        <span class="badge badge-light-secondary">
                                                            <i class="fa-solid fa-plus me-1"></i>{{ __('workshops.management.new_entry') }}
                                                        </span>
                                                    @endif
                                                </td>
                                            </tr>
                                ...
                                <div class="d-flex justify-content-end mt-10">
                                    <button type="submit" class="btn btn-success btn-lg">
                                        <i class="fa-solid fa-save me-2"></i>{{ __('workshops.management.save_volunteer_hours') }}
                                    </button>
                                </div>
                                <!--end::Actions-->
                            </form>
                        @else
                            <div class="d-flex flex-column flex-center py-10">
                                ...
                                <div class="fs-1 fw-bolder text-gray-400 mb-5">{{ __('workshops.management.no_attended_students') }}</div>
                                <div class="fs-6 text-gray-600 text-center">
                                    {{ __('workshops.management.only_attended_students') }}<br>
                                    {{ __('workshops.management.mark_attendance_first') }}
                                </div>
                            </div>
                        @endif
                    </div>
