    ...
    <div class="modal-dialog modal-dialog-centered mw-900px">
        <div class="modal-content">
            <form class="form" action="{{ route('admin.programs.store') }}" id="kt_modal_add_program_form" method="POST" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="path_points" id="createPathPointsData" value="">

                <div class="modal-header" id="kt_modal_add_program_header">
                    <h2 class="fw-bold">Create New Program</h2>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mt-4">
                                ...
                                <div class="create-available-points border rounded p-3" style="max-height: 300px; overflow-y: auto;">
                        ...
                        <div class="col-md-6">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <button type="button" class="btn btn-sm btn-light create-clear-path-btn">
                            ...
                            <div class="path-visual">
                                <div id="createProgramPath" class="program-path">
                            ...
                            <div class="mt-4 p-3 bg-light rounded">
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <span id="createTotalSteps" class="fw-bold">0</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-footer flex-center">
                    ...
                    <button type="submit" class="btn btn-primary" data-kt-users-modal-action="submit">
                        <span class="indicator-label">Create Program</span>
