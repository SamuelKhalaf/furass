...
<div class="modal fade" id="kt_modal_update_news" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered mw-750px">
        ...
        <div class="modal-content">
            <!--begin::Form-->
            <form class="form" id="kt_modal_update_news_form" method="POST" enctype="multipart/form-data"
                ...
                <div class="modal-header" id="kt_modal_update_news_header">
                    <!--begin::Modal title-->
                    <h2 class="fw-bold">{{ __('news.modal.update_news') }}</h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                ...
                <div class="modal-body py-10 px-lg-17">
                    <!--begin::Scroll-->
                    <div class="scroll-y me-n7 pe-7" id="kt_modal_update_news_scroll" data-kt-scroll="true"
                         data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto"
                         data-kt-scroll-dependencies="#kt_modal_update_news_header"
                        ...
                        <div class="row g-5 mb-7">
                            <div class="col-md-6 fv-row mb-7">
                                <label
                                    class=" fw-semibold fs-6 mb-2">{{__('news.modal.published_at')}}</label>
                                <input type="text" name="published_at" id="edit_published_at"
                        ...
                        <div class="row g-9 mb-7">
                            ...
                            <div class="col-12 fv-row">
                                ...
                                <div class="position-relative">
                                    <input type="file" id="edit_media" name="media"
                                           class="form-control form-control-lg form-control-solid"
                                           accept="image/*,video/*"/>
                                    <input type="hidden" id="current_media_path" name="current_media_path" value="">
                                </div>
                                <div class="d-flex align-items-center mt-2">
                                    <button type="button" id="edit_media_preview_btn"
                                            class="btn btn-icon btn-sm btn-light-primary me-2 d-none preview-trigger"
                                            data-content="">
                                        <i class="bi bi-eye fs-4"></i>
                                    </button>
                                    <button type="button" id="remove_media_btn"
                                            class="btn btn-icon btn-sm btn-light-danger me-2 d-none">
                ...
                <div class="modal-footer flex-center">
                    ...
                    <!--begin::Button-->
                    <button type="submit" id="kt_modal_update_news_submit" class="btn btn-primary"
